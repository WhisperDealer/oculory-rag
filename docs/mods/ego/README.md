---
id: "mods/ego/README"
title: "EGO — Enderal SE: Gameplay Overhaul"
slug: "README"
section: "mods/ego"
game: "enderal"
kind: "reference"
project: null
mod: "ego"
tags: ["enderal", "ego", "gameplay-overhaul", "third-party-mod", "source:enderal-mods"]
source_repo: "enderal-mods"
source_path: "arch-docs/EGO/README.md"
...
superseded_by: null
phase: null
confidence: {"author": 4, "community": 0, "unverified": 0, "upstream": 0, "verified": 9}
lines: 110
content_sha256: "27850f5321cb01ac1c81a56ca69b88dc7dc2b227cd7827beaa6018e725c324c5"
...
Reference documentation for **`Enderal SE - Gameplay Overhaul.esp`** ("EGO"), the gameplay
overhaul in most Enderal load orders and the biggest single source of record conflicts. Everything here was read off the plugin serialized to Spriggit YAML and
...
> **Why this exists.** EGO overrides **6203** existing records. Patches that touch combat,
...
| [`patching-ego.md`](patching-ego.md) | **The practical guide** — load order, conflict surface, and rules for writing patches against EGO |
...
will cause conflicts"* **[author]**. Our own patches belong in the "EGO patches" slot,
**after** EGO.
