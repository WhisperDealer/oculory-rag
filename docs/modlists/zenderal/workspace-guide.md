---
id: "modlists/zenderal/workspace-guide"
title: "Zenderal Patches — Spriggit Workspace Guide"
slug: "workspace-guide"
section: "modlists/zenderal"
game: "enderal"
kind: "guide"
project: "zenderal-patches"
mod: null
tags: ["enderal", "zenderal", "modlist", "patches", "claude-md", "source:zenderal"]
...
>
> Full detail in [`arch-docs/tools/spid.md`](../../tooling/spid.md) and
> [`spid-in-enderal.md`](../../enderal/tooling/spid-in-enderal.md). Read the second one before porting a
...
| Read this | For |
|---|---|
| **[`arch-docs/enderal/`](../../enderal/reference/README.md)** | **How Enderal actually works** — six documents mined from the serialized plugins and SureAI's own source. Start with [`plugin-architecture.md`](../../enderal/reference/plugin-architecture.md) |
| **[`arch-docs/EGO/`](../../mods/ego/README.md)** | **How EGO works and how to patch around it** — the list's gameplay overhaul, 6203 overridden records. Start with [`patching-ego.md`](../../mods/ego/patching-ego.md) before any combat/loot/crafting patch |
...
| **[`arch-docs/magic/`](magic/README.md)** | **The actual in-game value of every magic record** — load-order-winning SPEL/MGEF/ENCH/SCRL/ALCH/SHOU/GMST as JSON/CSV, with override chains, per-field diffs and recomputed spell costs. Start any magic-rebalance work here; regenerate with the `magic-extract` skill |
| [`arch-docs/tools/spid.md`](../../tooling/spid.md) | **SPID reference** — `_DISTR.ini` grammar and runtime behaviour for 7.3.x, rebuilt from upstream source. Corrects three things powerof3's [Nexus article](https://www.nexusmods.com/skyrimspecialedition/articles/6617) gets wrong |
| **[`arch-docs/tools/spid-in-enderal.md`](../../enderal/tooling/spid-in-enderal.md)** | **SPID in Enderal** — what a ported `_DISTR.ini` silently loses and why. Read before installing or authoring one: the list currently registers only **198/318** keyword entries |

Per pillar: combat patches start at [`arch-docs/enderal/combat.md`](../../enderal/reference/combat.md),
...
[`scripting-and-actorvalues.md`](../../enderal/reference/scripting-and-actorvalues.md).
...
how you write a patch, all documented in [`arch-docs/EGO/`](../../mods/ego/README.md):
...
> [`crafting-alchemy-economy.md`](../../enderal/reference/crafting-alchemy-economy.md#arcane-fever); the
