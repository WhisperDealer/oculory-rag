---
id: "tooling/spid"
title: "SPID — Spell Perk Item Distributor: reference"
slug: "spid"
section: "tooling"
game: "both"
kind: "reference"
project: null
mod: null
tags: ["spid", "distribution", "tooling", "source:zenderal"]
source_repo: "zenderal"
source_path: "arch-docs/tools/spid.md"
...
superseded_by: null
phase: null
confidence: {"author": 0, "community": 0, "unverified": 0, "upstream": 0, "verified": 19}
lines: 665
content_sha256: "09c7a7f7d2f2317c21693129a4eba85d6b0a9ed4f5afe0a56fbbe2235735a5d6"
...
> [`spid-in-enderal.md`](../enderal/tooling/spid-in-enderal.md) — that is where the Zenderal-specific traps live.
>
...
| `T` | `actor->IsPlayerTeammate()` **or** membership of faction `0005C84D` (PotentialFollowerFaction). That FormID is hardcoded, and in Enderal it is not a faction — see [`spid-in-enderal.md`](../enderal/tooling/spid-in-enderal.md#t-teammate-is-half-dead-in-enderal) |
