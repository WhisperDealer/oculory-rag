...
source_path: "arch-docs/enderal/factions.md"
...
1. **SPID and distribution configs must target record factions, not lore concepts.** There is no
   ...
   [`../tools/spid-in-enderal.md`](../tooling/spid-in-enderal.md) first — most ported filters die.)
